        ...
        <div className="flex items-center gap-3">
          ...
          {!user ? (
            <button
              ...
              className="text-xs text-gray-400 border border-gray-600 px-4 py-1.5 rounded-full hover:text-white hover:border-white transition"
            >
              Sign In
            </button>
          ) : (
